...
var prependTarget = function prependTarget(target, text) {
  target.prepend(text);
};

var submitDCClick = function submitDCClick(event) {
  event.preventDefault();
  ...
  var createComment = function createComment(response) {
...
/* WEBPACK VAR INJECTION */(function($) {var submitDDUpdate = function submitDDUpdate(dd, newDan) {
  ...
  var saveDirections = function saveDirections() {
    $.ajax({
      method: 'PUT',
...
var NewDanceDirection = function () {
  function NewDanceDirection(ddir) {
    _classCallCheck(this, NewDanceDirection);
  ...
  _createClass(NewDanceDirection, [{
    key: 'newId',
    value: function newId(json) {
      this.id = json.id;
    }
  }]);

  return NewDanceDirection;
}();

var submitDDAdd = function submitDDAdd(dd, newDan) {
  var ddirection = {
  ...
  var createDirection = function createDirection(response) {
...
/* WEBPACK VAR INJECTION */(function($) {var dividUpdateDirections = function dividUpdateDirections(dds, newDan) {
  dds.each(function (dd) {
    newDan.directions.push(submitDDUpdate(dd, newDan));
  });
};

var submitDDDEditClick = function submitDDDEditClick(event) {
  event.preventDefault();

  var dirListUpdate = $('tr.dd-editable');
  var dirListAdd = $('tr.dd-new');
  var newDan = new NewDance();

  var updateDance = function updateDance() {
    $.ajax({
      method: 'PUT',
  ...
  var createDance = function createDance() {
...
var NewDance = function () {
  function NewDance() {
    _classCallCheck(this, NewDance);
...
var dividNewDirections = function dividNewDirections(dds, newDan) {
  dds.each(function (dd) {
    newDan.directions.push(submitDDAdd(dd, newDan));
  });
};

var submitDDDClick = function submitDDDClick(event) {
  event.preventDefault();

  var dirListAdd = $('tr.dd-new');
  var newDan = new NewDance();

  var saveDance = function saveDance() {
    $.ajax({
      method: 'POST',
      url: '/api/dances',
      data: { dance: newDan }
  ...
  var createDance = function createDance(response) {
...
var appendTarget = function appendTarget(target, text) {
  target.append(text);
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_dance_comments_new__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_dance_comments_new___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_dance_comments_new__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_dances_edit__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_dances_edit___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_dances_edit__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_dances_new__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_dances_new___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_dances_new__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_dance_directions_edit__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_dance_directions_edit___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_dance_directions_edit__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_dance_directions_new__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_dance_directions_new___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_dance_directions_new__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_dance_directions_add__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_dance_directions_add___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_dance_directions_add__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_sitewide__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_sitewide___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_sitewide__);
/* eslint no-console:0 */
